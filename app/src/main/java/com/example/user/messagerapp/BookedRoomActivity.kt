...
class BookedRoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var progressBar = findViewById<ProgressBar>(R.id.progressShowBookedRoom)
        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                layoutBookedManager = LinearLayoutManager(this@BookedRoomActivity)
                bookedAdapter = RoomAdapter(bookedList!!, this@BookedRoomActivity)
